    ...
    <Stack sx={{backgroundImage: "linear-gradient(50deg, rgb(9,18,40) 0%, rgb(9,19,38) 25%, rgb(19,28,33) 35%, rgb(20,29,33) 65%, rgb(7,13,25) 75%, rgb(20,29,33) 100%)"}}>
        <Grid container sx={{paddingTop: "90px",display: "flex",flexDirection:{xs:"column",md:"row"},textAlign:{xs: "center",md:"left"}}}>
            ...
            <Grid item xs={12} md={4}>
                <Typography variant='h6' sx={{color: "white", fontWeight: "600",marginBottom: "13px", fontSize: "14px",fontFamily: 'inherit'}}>CONTACT US</Typography>
                <Typography variant='h6' sx={{color: "white",marginBottom: "13px", fontSize: "16px"}}>202 Helga Springs Rd, Crawford, TN 38554</Typography>
                <Typography variant='h6' sx={{color: "white",marginBottom: "13px",fontWeight: "600", fontSize: "16px","&:hover":{color: "rgb(44,188,165)"}, cursor: "pointer",fontFamily: 'inherit'}}>Call Us: 800.275.8777</Typography>
                <Typography variant='h6' sx={{color: "white",marginBottom: "13px", fontSize: "16px","&:hover":{color: "rgb(44,188,165)"}, cursor: "pointer",fontFamily: 'inherit'}}>alex@company.com</Typography>
            </Grid>

            <Grid item xs={12} md={4}>
                <Typography variant='h6' sx={{color: "white", fontWeight: "600",marginBottom: "13px", fontSize: "14px",fontFamily: 'inherit'}}>SIGN UP FOR EMAIL UPDATES</Typography>
        ...
        <Grid container sx={{paddingY: "20px"}}>
          ...
          <Typography variant='h6' sx={{color: "whitesmoke",fontSize: "15px",paddingLeft: {md:"20px"},paddingTop: "10px",fontFamily: 'inherit'}}>Copyright ©2022 Toka. All rights reserved.</Typography>
          </Grid>
          <Grid item xs={12} sm={12} md={4.8} lg={4.8} sx={{textAlign:{xs:"center",md:"right"}}}>
              {/* <Box sx={{textAlign:"center"}}> */}
              
              <List sx={{marginRight: "",fontSize:{sm: "10px",md:"5px"},color: "white",display: "flex",flexDirection:{xs: "column",sm: "row"},justifyContent:"space-between",textAlign:"center",fontFamily: 'inherit'}}>
              <ListItemText sx={{fontFamily: 'inherit'}}>Home</ListItemText>
