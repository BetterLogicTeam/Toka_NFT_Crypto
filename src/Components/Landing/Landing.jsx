...
function Landing() {
  ...
  return (
    <div>
      <Stack>
        <Grid container sx={{ paddingTop: { xs: "100px", sm: "190px" } }}>
        ...
        <Grid container>
          ...
          >
            ...
            <Typography
              variant="h3"
              sx={{ color: "white", fontSize: { xs: "30px", sm: "50px" } }}
            >
              2K+
            </Typography>
            <Typography
            ...
            <Typography
              variant="subtitle6"
              sx={{ color: "white", paddingLeft: { xs: "10px", sm: "30px" } }}
            >
              WALLET TYPES
            </Typography>
            </Box>
        ...
        <Grid container sx={{ marginTop: { xs: "50px", md: "140px" } }}>
          <Grid item xs={12} sx={{ textAlign: "center" }}>
            ...
            <Typography
              variant="h6"
              sx={{ color: "white", fontSize: "47px", fontWeight: "400" }}
            >
        ...
        >
          ...
          <Grid item xs={12} md={5.2}>
            ...
            >
              ...
              <Typography
                variant="h6"
                sx={{ color: "rgb(166,167,171)", fontSize: "16px" }}
              >
        ...
        <Grid container sx={{ paddingTop: { md: "120px" } }}>
          ...
          <Grid container sx={{marginTop:{md:"50px",xs:"40px"}}}>
            ...
            <Rating name="read-only" value={value} readOnly />
               <Typography variant="h6" sx={{color: "rgb(166,167,171)",marginY:{md:"30px"},fontSize:{md:"20px"}}}>Great! Compared to everything else I’ve ever used, this is the best technology.</Typography>
              ...
              <Typography variant="h6" sx={{color: "rgb(166,167,171)",fontSize:{md:"15px",xs:"13px"},fontWeight: "700",marginTop:{md:"-40px",xs:"-40px"}}}>Developer</Typography>
            </Grid>
            ...
            <Rating name="read-only" value={value} readOnly />
              ...
              <Typography variant="h6" sx={{color: "rgb(166,167,171)",fontSize:{md:"15px",xs:"13px"},fontWeight: "700",marginTop:{md:"-40px",xs:"-40px"}}}>HR manager</Typography>
            </Grid>
          </Grid>
          ...
          <Grid container sx={{marginBottom:{md:"140px",xs:"70px"}}}>
            ...
            <Rating name="read-only" value={value} readOnly />
              ...
              <Typography variant="h6" sx={{color: "rgb(166,167,171)",fontSize:{md:"15px",xs:"13px"},fontWeight: "700",marginTop:{md:"-40px",xs:"-40px"}}}>Project manager</Typography>
            </Grid>
          ...
          <Grid container sx={{marginBottom:{md:"120px",xs:"80px"}}} >
            ...
            <Grid item xs={12} md={10.4} sx={{backgroundColor:"#2A2B3169",borderRadius:"10px",borderColor:"#849AAA85",padding:{xs:"30px 30px",md:"60px 80px"},borderWidth:"1px",borderStyle:"solid",display:"flex",justifyContent:"space-between",flexDirection:{xs:"column",sm:"row"},textAlign:{xs:"center",sm:"left"},marginX:{xs:"10px",md:"0"}}}>
                <Box>
                <Typography variant="h6" sx={{color:"white",fontSize:{md:"40px",sm:"35px"},fontWeight:"545",lineHeight:"1.2"}}>Let’s start your crypto</Typography>
                <Box sx={{display:"flex",justifyContent:{xs:"center"}}}>
                <Typography variant="h6" sx={{color:"rgb(44,188,165)",fontSize:{md:"40px",sm:"35px"},fontWeight:"545",lineHeight:"1.2"}}>investment</Typography>
                <Typography variant="h6" sx={{color:"white",fontSize:{md:"40px",sm:"35px"},fontWeight:"545",lineHeight:"1.2",paddingLeft:"12px"}}>now</Typography>
                <ImageList>
                ...
                <Typography variant="h6" sx={{color: "rgb(166,167,171)"}}>Choose from 150+ cryptocurrencies</Typography>
                </Box>
                <Box>
                <Button
              sx={{
